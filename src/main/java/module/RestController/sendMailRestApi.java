...
public class sendMailRestApi {
	...
	public void sendMailOrder(@RequestBody Order order) {
		...
		if (order.getStatus() == 1) {
			...
			trangthai = "TVTS đã xác nhận đơn hàng của bạn";
		} else if (order.getStatus() == 3) {
			trangthai = "Bạn đã hủy đơn hàng :(";
		} else if (order.getStatus() == 4) {
			trangthai = "Cám ơn bạn đã tin tưởng TVTS";
		} else {
		...
		for (OrderDetail item : list) {
			content.append("\r\n"
					...
					+ "                <img src=\"https://firebasestorage.googleapis.com/v0/b/webstorbook.appspot.com/o/"
		...
		content.append("<div style=\"margin-top: 20px;\">\r\n"
				...
				+ "                <p style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold;\">Cám ơn bạn đã tin tưởng TVTS!</p>\r\n"
